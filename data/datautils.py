...
def build_dataset(set_id, transform, data_root, mode='test', n_shot=None):
    ...
    if set_id == 'I':
        ...
        print(set_id, os.path.join(data_root, ID_to_DIRNAME[set_id.lower()]), data_root)
        if mode == 'train' and n_shot:
            testset = build_fewshot_dataset(set_id, data_root, transform, mode=mode, n_shot=n_shot)
        else:
            testset = build_fewshot_dataset(set_id, data_root, transform, mode=mode)
